...
<div class="pagerRelative"><p class="number"><?php echo op_include_pager_navigation($pager, 'diary/listMember?page=%d&id='.$member->getId().(($year && $month) ? '&year='.$year.'&month='.$month.(($day) ? '&day='.$day : '') : '')); ?></p></div>
